 ...
 */
final class Version20251207220753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comentario (id INT AUTO_INCREMENT NOT NULL, contenido VARCHAR(255) DEFAULT NULL, fecha_hora DATETIME NOT NULL, estado_moderacion VARCHAR(50) NOT NULL, votos_positivos INT NOT NULL, votos_negativos INT NOT NULL, noticia_id INT NOT NULL, usuario_id INT DEFAULT NULL, INDEX IDX_4B91E70299926010 (noticia_id), INDEX IDX_4B91E702DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE noticia (id INT AUTO_INCREMENT NOT NULL, titulo VARCHAR(100) NOT NULL, subtitulo VARCHAR(150) NOT NULL, cuerpo LONGTEXT NOT NULL, fecha_publicacion DATETIME NOT NULL, estado VARCHAR(100) NOT NULL, valoracion_promedio DOUBLE PRECISION DEFAULT NULL, imagen VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, correo VARCHAR(150) NOT NULL, nombre_usuario VARCHAR(100) NOT NULL, contraseña VARCHAR(150) NOT NULL, rol VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
